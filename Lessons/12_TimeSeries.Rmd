...
# WARNING: here n = 303 leads to 30 days a month, which will cause mismatch after converting to time-series (ts). Increase the n and take average by group to make ts consistent with results from interpolation
linearinterpolation.update <- 
  as.data.frame(approx(Mendotadata, n = 500, method = "linear"))
