...
install.packages("streamMetabolizer", dependencies = TRUE, repos = c("https://owi.usgs.gov/R", "https://cran.studio.com"))
...
> Crane Creek. Nitrate concentration remains relatively constant across instantaneous flow.

## Hysteresis Loops

Hysteresis occurs when the concentration varies with discharge in a different relationship on the rising and falling limbs of a storm. This can be caused by _flushing_ behavior or _dilution_ behavior. The reason could be that at different stages of storming, either quickflow or baseflow dominates the increase in discharge.
...
> counterclockwise, suggesting that the source for rising limb has (i.e. quickflow) lower concentration than that (i.e. baseflow) for falling limb.
...
> GPP = Gross Primary Productivity; ER = Ecosystem Respiration
...
Eno.DO <- Enodat[[1]] %>%
  ...
  # Convert time in UTC format to solar time
