...
- water flows in steam, river; lake and wetland have relatively static water system
- Lake is usually in depression
- Wetland has emergence of vegetation
- The bottom of lake rarely receives light
...
# Water has the highest density at 4 degree C. Once T goes lower, water will expand while ice crystal is forming, reducing the density
...
<add notes here>
dimictic -> mixing twice per year; fall turnover, spring turnover
...
<add notes here>
Wind & density gradient
Spring: as ice on the top melts and water near the surface gets warmer, water column will reach a point where the whole column is at about 4 degree C and mixing along the column can occurs.
Fall: the reverse process of spring
